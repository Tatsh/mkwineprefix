...
You write comprehensive pytest test suites for mkwineprefix. Follow all conventions in
...
def test_my_command_success(runner: CliRunner, mocker: MockerFixture) -> None:
    mock_func = mocker.patch('mkwineprefix.commands.module.some_function')
